...
local Window = Fluent:CreateWindow({
    Title="Axion Hub Blox-Fruits [ Free ]",
    SubTitle="by _ToBiii", 
    TabWidth=160, 
    Theme="Axion",
    Acrylic=false,
...
local Tabs = {
    ...
    Item=Window:AddTab({ Title="Tab Items" }),
...
Tabs.Info:AddParagraph({
    Title="Update",
    Content="Tôi Sẽ Cập Nhiều Nhiều Tính Năng Hơn Để Mang Đến Cho Các Bạn Trải Nghiệm Tốt Nhất , Nếu Có Lỗi Hãy Kiên Nhẫn Chờ Tôi Fix Vì Tôi Không Thể Thử Nghiệm Hết Cảm Ơn..."
})
Tabs.Info:AddParagraph({
